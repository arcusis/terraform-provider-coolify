...
func NewApplicationResource() resource.Resource {
	return &genericResource{
		...
		fields: []resourceField{
			{Name: "type", Kind: kindString, Required: true, Send: true, ForceNew: true, Description: "Application type: dockerimage, dockerfile, public, private-gh-app, private-deploy-key, or dockercompose."},
			{Name: "project_uuid", Kind: kindString, Required: true, Send: true, ForceNew: true, Description: "UUID of the project to deploy into."},
			{Name: "server_uuid", Kind: kindString, Required: true, Send: true, ForceNew: true, Description: "UUID of the server to deploy on."},
			{Name: "environment_name", Kind: kindString, Required: true, Send: true, ForceNew: true, Description: "Name of the environment (e.g. production, staging)."},
